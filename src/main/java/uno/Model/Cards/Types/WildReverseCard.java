...
public class WildReverseCard extends AbstractCard {

    public WildReverseCard() {
        super(CardColor.WILD, CardValue.WILD_REVERSE); // Il colore "base" è WILD
    }

    public WildReverseCard(CardFace lightSide, CardFace darkSide) {
    ...
    public boolean canBePlayedOn(Card topCard, Game game) {
        ...
        if (activeValue == CardValue.WILD_REVERSE) {
            return true;
        }
