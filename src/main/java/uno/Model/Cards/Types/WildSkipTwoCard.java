...
public class WildSkipTwoCard extends AbstractCard {

    public WildSkipTwoCard() {
        super(CardColor.WILD, CardValue.WILD_SKIP_TWO); // Il colore "base" è WILD
    }

    public WildSkipTwoCard(CardFace lightSide, CardFace darkSide) {
    ...
    public boolean canBePlayedOn(Card topCard, Game game) {
        ...
        if (activeValue == CardValue.WILD_SKIP_TWO) {
            return true;
        }
