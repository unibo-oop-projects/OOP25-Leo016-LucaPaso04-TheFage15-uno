...
public class WildForcedSwapCard extends AbstractCard {

    public WildForcedSwapCard() {
        super(CardColor.WILD, CardValue.WILD_FORCED_SWAP); // Il colore "base" è WILD
    }

    public WildForcedSwapCard(CardFace lightSide, CardFace darkSide) {
    ...
    public boolean canBePlayedOn(Card topCard, Game game) {
        ...
        if (activeValue == CardValue.WILD_FORCED_SWAP) {
            return true;
        }
