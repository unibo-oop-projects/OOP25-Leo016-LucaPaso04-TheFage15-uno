...
public class WildTargetedDrawTwoCard extends AbstractCard {

    public WildTargetedDrawTwoCard() {
        super(CardColor.WILD, CardValue.WILD_TARGETED_DRAW_TWO); // Il colore "base" è WILD
    }

    public WildTargetedDrawTwoCard(CardFace lightSide, CardFace darkSide) {
    ...
    public boolean canBePlayedOn(Card topCard, Game game) {
        ...
        if (activeValue == CardValue.WILD_TARGETED_DRAW_TWO) {
            return true;
        }
